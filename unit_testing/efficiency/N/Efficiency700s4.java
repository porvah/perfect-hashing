...
public class Efficiency700s4{
    HashTableWithNSpace<Integer> hashTable = new HashTableWithNSpace<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/700s4.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/700s5.txt");
