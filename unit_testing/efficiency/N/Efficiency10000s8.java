...
public class Efficiency10000s8{
    HashTableWithNSpace<Integer> hashTable = new HashTableWithNSpace<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/10000s8.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/10000s9.txt");
