...
public class Efficiency10s6{
    HashTableWithNSpace<Integer> hashTable = new HashTableWithNSpace<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/10s6.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/10s7.txt");
