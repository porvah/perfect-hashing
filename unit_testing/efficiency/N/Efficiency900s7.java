...
public class Efficiency900s7{
    HashTableWithNSpace<Integer> hashTable = new HashTableWithNSpace<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/900s7.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/900s8.txt");
