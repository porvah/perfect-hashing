...
public class Efficiency600s1{
    HashTableWithNSpace<Integer> hashTable = new HashTableWithNSpace<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/600s1.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/600s2.txt");
