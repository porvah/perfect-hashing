...
public class Efficiency200s3{
    HashTableWithNSpace<Integer> hashTable = new HashTableWithNSpace<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/200s3.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/200s4.txt");
