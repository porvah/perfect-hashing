...
public class Efficiency5000s1{
    HashTableWithNSpace<Integer> hashTable = new HashTableWithNSpace<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/5000s1.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/5000s2.txt");
