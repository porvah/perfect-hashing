...
public class Efficiency800s4{
    HashTableWithNSpace<Integer> hashTable = new HashTableWithNSpace<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/800s4.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/800s5.txt");
