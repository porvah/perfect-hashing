...
public class Efficiency900s9{
    HashTableWithNSpace<Integer> hashTable = new HashTableWithNSpace<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/900s9.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/900s10.txt");
