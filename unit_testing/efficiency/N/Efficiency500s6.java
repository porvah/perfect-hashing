...
public class Efficiency500s6{
    HashTableWithNSpace<Integer> hashTable = new HashTableWithNSpace<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/500s6.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/500s7.txt");
