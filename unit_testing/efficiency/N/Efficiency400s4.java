...
public class Efficiency400s4{
    HashTableWithNSpace<Integer> hashTable = new HashTableWithNSpace<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/400s4.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/400s5.txt");
