...
public class Efficiency1000000s4{
    HashTableWithNSpace<Integer> hashTable = new HashTableWithNSpace<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/1000000s4.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/1000000s5.txt");
