...
public class Efficiency100000s9{
    HashTableWithNSpace<Integer> hashTable = new HashTableWithNSpace<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/100000s9.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/100000s10.txt");
