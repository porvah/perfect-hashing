...
public class Efficiency700s6{
    HashTableWithNSpace<Integer> hashTable = new HashTableWithNSpace<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/700s6.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/700s7.txt");
