...
public class Efficiency500s3{
    HashTableWithNSpace<Integer> hashTable = new HashTableWithNSpace<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/500s3.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/500s4.txt");
