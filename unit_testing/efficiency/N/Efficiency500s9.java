...
public class Efficiency500s9{
    HashTableWithNSpace<Integer> hashTable = new HashTableWithNSpace<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/500s9.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/500s10.txt");
