...
public class Efficiency10000s6{
    HashTableWithNSpace<Integer> hashTable = new HashTableWithNSpace<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/10000s6.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/10000s7.txt");
