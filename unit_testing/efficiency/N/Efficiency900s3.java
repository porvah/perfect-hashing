...
public class Efficiency900s3{
    HashTableWithNSpace<Integer> hashTable = new HashTableWithNSpace<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/900s3.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/900s4.txt");
