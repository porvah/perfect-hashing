...
public class Efficiency700s3{
    HashTableWithNSpace<Integer> hashTable = new HashTableWithNSpace<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/700s3.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/700s4.txt");
