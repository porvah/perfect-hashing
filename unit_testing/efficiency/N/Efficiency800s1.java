...
public class Efficiency800s1{
    HashTableWithNSpace<Integer> hashTable = new HashTableWithNSpace<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/800s1.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/800s2.txt");
