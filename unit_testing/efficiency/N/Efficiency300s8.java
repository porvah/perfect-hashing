...
public class Efficiency300s8{
    HashTableWithNSpace<Integer> hashTable = new HashTableWithNSpace<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/300s8.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/300s9.txt");
