...
public class Efficiency1000s8{
    HashTableWithN2Space<Integer> hashTable = new HashTableWithN2Space<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/1000s8.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/1000s9.txt");
