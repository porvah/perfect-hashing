...
public class Efficiency700s1{
    HashTableWithN2Space<Integer> hashTable = new HashTableWithN2Space<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/700s1.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/700s2.txt");
