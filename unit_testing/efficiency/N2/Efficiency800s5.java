...
public class Efficiency800s5{
    HashTableWithN2Space<Integer> hashTable = new HashTableWithN2Space<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/800s5.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/800s6.txt");
