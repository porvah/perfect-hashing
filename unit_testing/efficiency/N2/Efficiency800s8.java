...
public class Efficiency800s8{
    HashTableWithN2Space<Integer> hashTable = new HashTableWithN2Space<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/800s8.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/800s9.txt");
