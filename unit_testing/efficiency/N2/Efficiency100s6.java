...
public class Efficiency100s6{
    HashTableWithN2Space<Integer> hashTable = new HashTableWithN2Space<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/100s6.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/100s7.txt");
