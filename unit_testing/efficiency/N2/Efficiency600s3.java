...
public class Efficiency600s3{
    HashTableWithN2Space<Integer> hashTable = new HashTableWithN2Space<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/600s3.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/600s4.txt");
