...
public class Efficiency300s1{
    HashTableWithN2Space<Integer> hashTable = new HashTableWithN2Space<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/300s1.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/300s2.txt");
