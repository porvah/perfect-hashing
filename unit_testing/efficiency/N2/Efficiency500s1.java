...
public class Efficiency500s1{
    HashTableWithN2Space<Integer> hashTable = new HashTableWithN2Space<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/500s1.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/500s2.txt");
