...
public class Efficiency10s4{
    HashTableWithN2Space<Integer> hashTable = new HashTableWithN2Space<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/10s4.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/10s5.txt");
