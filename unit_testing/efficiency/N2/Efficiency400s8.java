...
public class Efficiency400s8{
    HashTableWithN2Space<Integer> hashTable = new HashTableWithN2Space<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/400s8.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/400s9.txt");
