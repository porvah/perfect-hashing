...
public class Efficiency600s6{
    HashTableWithN2Space<Integer> hashTable = new HashTableWithN2Space<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/600s6.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/600s7.txt");
