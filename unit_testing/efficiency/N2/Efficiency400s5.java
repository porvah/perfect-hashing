...
public class Efficiency400s5{
    HashTableWithN2Space<Integer> hashTable = new HashTableWithN2Space<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/400s5.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/400s6.txt");
