...
public class Efficiency200s4{
    HashTableWithN2Space<Integer> hashTable = new HashTableWithN2Space<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/200s4.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/200s5.txt");
