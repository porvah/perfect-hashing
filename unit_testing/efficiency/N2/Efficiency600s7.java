...
public class Efficiency600s7{
    HashTableWithN2Space<Integer> hashTable = new HashTableWithN2Space<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/600s7.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/600s8.txt");
