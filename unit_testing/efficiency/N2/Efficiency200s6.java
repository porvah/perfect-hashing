...
public class Efficiency200s6{
    HashTableWithN2Space<Integer> hashTable = new HashTableWithN2Space<>();
    Integer[] keys1 = KeysReader.getIntegersFromFile("test_files/efficiency/200s6.txt");
    Integer[] keys2 = KeysReader.getIntegersFromFile("test_files/efficiency/200s7.txt");
